...
{
    /// <summary>Standard app canvas behind all dashboard screens.</summary>
    public const string PageBackground = "#f5f7f9";
    ...
    /// <summary>Gap between left config column and right preview (rem).</summary>
    public const double FlowColumnGapRem = 2.75;

    /// <summary>Preview pane width as fraction of preview column (68%).</summary>
    public const double PreviewPaneWidthPercent = 68.0;
    ...
    public static string BuildFlowLayoutCss()
    {
        ...
        sb.Append("@media (min-width: 1024px) { .dash-flow-grid { display: grid; grid-template-columns: minmax(0, 480px) minmax(0, 1fr); align-items: stretch; } } ");
