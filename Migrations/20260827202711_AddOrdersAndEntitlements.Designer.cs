...
namespace EBookDashboard.Migrations
{
    ...
    [Migration("20260827202711_AddOrdersAndEntitlements")]
    partial class AddOrdersAndEntitlements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EBookDashboard.Models.BookBillingState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("BilledPageCount")
                        .HasColumnType("int");

                    b.Property<int>("BookId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("LastBilledAtUtc")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("EBookDashboard.Models.Entitlement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "BookId", "Type", "ScopeKey");
            ...
            modelBuilder.Entity("EBookDashboard.Models.FormattingTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 10,
                            DisplayName = "Elegant Trade",
                            IsPremium = true,
                            StyleKey = "ElegantTrade"
                        },
                        new
                        {
                            Id = 11,
                            DisplayName = "Elegant Trade (POD)",
                            IsPremium = true,
            ...
            modelBuilder.Entity("EBookDashboard.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EBookDashboard.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PricingRuleKey")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
            ...
            modelBuilder.Entity("EBookDashboard.Models.OrderItem", b =>
                {
                    b.HasOne("EBookDashboard.Models.Order", "Order")
                        .WithMany("Items")
