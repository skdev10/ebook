...
namespace EBookDashboard.Migrations
{
    ...
    [Migration("20260727174553_AddPublishingPipelineEntities")]
    partial class AddPublishingPipelineEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EBookDashboard.Models.Plans", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateddAt = new DateTime(2026, 7, 27, 17, 45, 51, 775, DateTimeKind.Utc).AddTicks(9915),
                            Currency = "usd",
                            IsActive = 1,
                            MaxChapters = 0,
                            MaxEBooks = 0,
                        ...
                        new
                        {
                            ...
                            AllowFullDashboard = false,
                            AllowPublishing = false,
                            CreateddAt = new DateTime(2026, 7, 27, 17, 45, 51, 775, DateTimeKind.Utc).AddTicks(9931),
                            Currency = "usd",
                            IsActive = 1,
                            MaxChapters = 0,
                            MaxEBooks = 0,
                        ...
                        new
                        {
                            ...
                            AllowFullDashboard = false,
                            AllowPublishing = false,
                            CreateddAt = new DateTime(2026, 7, 27, 17, 45, 51, 775, DateTimeKind.Utc).AddTicks(9937),
                            Currency = "usd",
                            IsActive = 1,
                            MaxChapters = 0,
                            MaxEBooks = 0,
            ...
            modelBuilder.Entity("EBookDashboard.Models.LayoutProfile", b =>
                {
                    b.HasOne("EBookDashboard.Models.Project", "Project")
                        .WithOne("LayoutProfile")
                        .HasForeignKey("EBookDashboard.Models.LayoutProfile", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
