    ...
    public class AudioToTextController : ControllerBase
    {
            ...
            [FromForm] int? chapter)
        {
            ...
            try
            {
                ...
                {
                    _logger.LogWarning("ExternalApi:ApiKey empty — skipping external transcription.");
                }
                ...
                {
                    failMessage =
                        "Voice input is unavailable: set ExternalApi:ApiKey or OpenAI:ApiKey (environment: OpenAI__ApiKey).";
                    return StatusCode(503, new
                    {
                        success = false,
                        text = "",
